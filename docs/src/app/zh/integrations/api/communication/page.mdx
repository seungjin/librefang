...
列出已配置的通道适配器及其状态。支持 in-process 适配器集（Discord、Slack、WhatsApp、Matrix、Email、Teams、Mattermost、IRC、Google Chat、Twitch、Rocket.Chat、Zulip、XMPP、LINE、Reddit 等）以及 sidecar 通道（Telegram、ntfy、Gotify、Mastodon、Bluesky 通过 `librefang-sdk` Python 包以 sidecar 形式提供）。
